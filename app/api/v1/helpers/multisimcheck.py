...
class MultiSimCheck:
    ...
    def validate_imeis_capacity(core_base_url, api_version, imeis_list):
        ...
        for device_imeis_rec in imeis_list:
            ...
            # take imeis count to check for match in imeiquantitysupport,
            # simslot and (removable_euicc, nonremovable_euicc, removable_euicc, removable_uicc)
            ...
            for tac in device_unique_list:
                ...
                if gsma_response["gsma"] is None:
                    ...
                    if not sim_slots == "not known":
                        ...
                        # print("We are in the else part for imeiquantitysupport")
                        ...
                        if not imeiquantitysupport == "not known":
                            ...
                            if total_sim_capacity:  # if list is not empty
                                combo_euicc_uicc = total_sim_capacity[0]

                                if not combo_euicc_uicc == imeis_count:
                                    pass  # condition met
                                else:
